...
import 'package:anikkumarnath/Edit_page.dart';
import 'package:anikkumarnath/Follower_Page.dart';
import 'package:anikkumarnath/Following_Page.dart';
import 'package:anikkumarnath/Messenger_Page.dart';
import 'package:anikkumarnath/Posts_Page.dart';
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                              ...
                              color: Color.fromARGB(255, 1, 34, 20),
                            ),
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            ...
                            fontStyle: FontStyle.normal,
                            color: Color.fromARGB(255, 20, 14, 20),
                          ),
                          textAlign: TextAlign.start,
                        ),
                      ],
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        children: [
                          Text(
                            ...
                            style: TextStyle(
                              ...
                              fontWeight: FontWeight.w500,
                              fontSize: 20,
                              color: Color.fromARGB(126, 135, 188, 241),
                            ),
                          ),
                          Icon(
                            Icons.create_rounded,
                            color: Color.fromARGB(126, 1, 21, 41),
                            size: 18,
                          ),
                        ],
                      ),
                    ...
                    Container(
                      ...
                      child: Text(
                        "Anik Kumar Nath, one of the trainees of Android Game Development Traning."
                        " This Training Center locates at Sat Raster Mor,"
                        " Khulna. He lives in Boikali, Khalishpur, Khulna",
                        style: TextStyle(
                          fontSize: 16,
                          fontWeight: FontWeight.w500,
                          fontStyle: FontStyle.normal,
                          color: Color.fromARGB(126, 0, 21, 27),
                        ),
